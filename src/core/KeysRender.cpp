                            ...
                            const KeysRenderOptions& options)
{
    ...
    // SappLink CC-in: mapped controllers steer KeysParams during the render,
    // exactly as they steer the plugin's parameters live. The CC event is
    // still forwarded to the engine (SFZ locc/hicc conditions, engine-native
    // CC1/CC11/CC64 behavior).
    KeysParams liveParams = options.params;
