...
//   mechNoise .18  width 1  vintage 0  drive 0  roomLevel .3  roomSize 1
//   roomDecay .9  masterGain 0  limiter on  quality Normal  clean 0
//
// Mechanics policy (sappkeys #3): several instruments each running their own
// modeled noise stack into audible grain on an unattended station, so no
