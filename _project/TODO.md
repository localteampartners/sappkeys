...
- [ ] Tag `v0.10.0` and let the release workflow build it once the self-hosted
      runner is back up (v0.9.0 was never tagged either). The code is committed
      and pushed; CMake already says 0.10.0, which is what the CI
      tag-vs-version guard compares against.
